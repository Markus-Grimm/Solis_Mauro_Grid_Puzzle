...
[System.Serializable]
public class LevelElement // Define los objetos en un nivel por mapeado de caracteres a prefabs
{
...
public class LevelBuilder : MonoBehaviour
{
    ...
    GameObject GetPrefab(char c)
    {
        ...
        if (levelElement != null) return levelElement.m_Prefab;
        else return null;
    }
    ...
    public void NextLevel()
    {
        ...
        {
            m_CurrentLevel = 0; // Vuelvo al nivel 1
        }
    }
    ...
    public void Build()
    {
        ...
        //Centra las coordenadas del nivel en 0,0
